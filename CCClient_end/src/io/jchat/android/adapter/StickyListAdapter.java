...
public class StickyListAdapter extends BaseAdapter implements
	...
	public StickyListAdapter(Context context, List<UserLetterBean> list,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.select_friend_item,
					parent, false);
			holder.itemLl = (LinearLayout) convertView
					.findViewById(R.id.select_friend_item_ll);
			holder.checkBox = (CheckBox) convertView
					.findViewById(R.id.selected_cb);
		...
		holder.itemLl.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mSelectMap.size() > 0) {
					...
					mSelectedNum.setText(String.format(
							mContext.getString(R.string.selected_num),
