...
public class GroupMemberGridAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater
					.inflate(R.layout.group_grid_view_item, null);
			viewTag = new ItemViewTag(
					(CircleImageView) convertView
							.findViewById(R.id.grid_avatar),
		...
		if (mIsGroup) {
			...
			if (position == 0) {
				Conversation conv = JMessageClient.getSingleConversation(
	...
	class ItemViewTag {
		...
		public ItemViewTag(CircleImageView icon, TextView name,
