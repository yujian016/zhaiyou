...
public class MeInfoActivity extends BaseActivity {
	...
	public void showSexDialog(final UserInfo.Gender gender) {
		...
		RelativeLayout womanRl = (RelativeLayout) view
				.findViewById(R.id.woman_rl);
		ImageView manSelectedIv = (ImageView) view
				.findViewById(R.id.man_selected_iv);
		ImageView womanSelectedIv = (ImageView) view
				.findViewById(R.id.woman_selected_iv);
			...
			public void onClick(View v) {
				...
				case R.id.man_rl:
					if (gender != UserInfo.Gender.male) {
						...
						JMessageClient.updateMyInfo(UserInfo.Field.gender,
									...
									public void gotResult(final int status,
										...
										if (status == 0) {
											...
											Toast.makeText(
													MeInfoActivity.this,
													MeInfoActivity.this
															.getString(R.string.modify_success_toast),
	...
	public void startModifySignatureActivity() {
		Intent intent = new Intent();
		intent.putExtra("OldSignature", JMessageClient.getMyInfo()
				.getSignature());
