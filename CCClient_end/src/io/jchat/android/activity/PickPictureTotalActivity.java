...
public class PickPictureTotalActivity extends BaseActivity {
		...
		public void handleMessage(Message msg) {
			...
			if (activity != null) {
				...
				case SCAN_OK:
					...
					activity.adapter = new AlbumListAdapter(activity,
							activity.list = activity
									.subGroupOfImage(activity.mGruopMap),
							activity.mListView, activity.mDensity);
				...
				case SCAN_ERROR:
					...
					Toast.makeText(
							activity,
							activity.getString(R.string.sdcard_not_prepare_toast),
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// mGroupGridView = (GridView)
		// findViewById(R.id.pick_picture_total_grid_view);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				List<String> childList = mGruopMap.get(list.get(position)
						.getFolderName());
				mIntent.setClass(PickPictureTotalActivity.this,
						PickPictureActivity.class);
				mIntent.putStringArrayListExtra("data",
						(ArrayList<String>) childList);
				startActivityForResult(mIntent,
						JChatDemoApplication.REQUEST_CODE_SELECT_ALBUM);
	...
	private void getImages() {
		...
		mProgressDialog = ProgressDialog.show(this, null,
				PickPictureTotalActivity.this.getString(R.string.loading));
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				ContentResolver mContentResolver = PickPictureTotalActivity.this
						.getContentResolver();
