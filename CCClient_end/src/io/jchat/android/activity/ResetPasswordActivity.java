		...
		public void onClick(View view) {
			...
			case R.id.commit_btn:
				...
				if (TextUtils.isEmpty(newPwd) || TextUtils.isEmpty(confirmPwd)) {
					Toast.makeText(
							mContext,
							mContext.getString(R.string.password_not_null_toast),
					...
					if (newPwd.equals(confirmPwd)) {
						if (JMessageClient.isCurrentUserPasswordValid(newPwd)) {
							Toast.makeText(
									mContext,
									mContext.getString(R.string.password_same_to_previous),
									Toast.LENGTH_SHORT).show();
							return;
						}
						...
						dialog.show();
						JMessageClient.updateUserPassword(getIntent()
								.getStringExtra("oldPassword"), newPwd,
								new BasicCallback() {
									@Override
						...
						Toast.makeText(
								mContext,
								mContext.getString(R.string.password_not_match_toast),
								Toast.LENGTH_SHORT).show();
				}
				break;
			}
