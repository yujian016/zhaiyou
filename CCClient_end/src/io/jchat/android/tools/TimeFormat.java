...
public class TimeFormat {
	...
	public TimeFormat(Context context, long timeStamp) {
		...
		SimpleDateFormat format = new SimpleDateFormat(
				mContext.getString(R.string.time_format_accuracy), Locale.CHINA);
	...
	public String getTime() {
		...
		SimpleDateFormat format = new SimpleDateFormat(
				mContext.getString(R.string.time_format_hours), Locale.CHINA);
	...
	public String getDetailTime() {
		...
		String date = format.format(mTimeStamp);
		SimpleDateFormat format1 = new SimpleDateFormat(
				mContext.getString(R.string.time_format_year_month_day),
				Locale.CHINA);
