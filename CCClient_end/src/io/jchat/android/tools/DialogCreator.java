...
public class DialogCreator {
	...
	public static Dialog createBaseCustomDialog(Context context, String title,
	...
	public static Dialog createDelConversationDialog(Context context,
		...
		final LinearLayout deleteLl = (LinearLayout) v
				.findViewById(R.id.delete_conv_ll);
		titleTv.setText(title);
	...
	public static Dialog createLongPressMessageDialog(Context context,
			String title, boolean hide, View.OnClickListener listener) {
		Dialog dialog = new Dialog(context, R.style.default_dialog_style);
		View view = LayoutInflater.from(context).inflate(
				R.layout.dialog_msg_alert, null);
		dialog.setContentView(view);
		Button copyBtn = (Button) view.findViewById(R.id.copy_msg_btn);
		Button forwardBtn = (Button) view.findViewById(R.id.forward_msg_btn);
	...
	public static Dialog createResendDialog(Context context,
	...
	public static Dialog createDeleteMessageDialog(Context context,
			View.OnClickListener listener) {
		Dialog dialog = new Dialog(context, R.style.default_dialog_style);
		LayoutInflater inflater = LayoutInflater.from(context);
	...
	public static Dialog createExitGroupDialog(Context context,
			View.OnClickListener listener) {
		Dialog dialog = new Dialog(context, R.style.default_dialog_style);
		LayoutInflater inflater = LayoutInflater.from(context);
		View v = inflater.inflate(R.layout.dialog_base_with_button, null);
	...
	public static Dialog createSetAvatarDialog(Context context,
			View.OnClickListener listener) {
		Dialog dialog = new Dialog(context, R.style.default_dialog_style);
		...
		Button pickPictureBtn = (Button) view
				.findViewById(R.id.pick_picture_btn);
				...
				case R.id.commit_btn:
					...
					if (JMessageClient.isCurrentUserPasswordValid(input)) {
						...
						Toast toast = Toast
								.makeText(
										context,
										context.getString(R.string.input_password_error_toast),
										Toast.LENGTH_SHORT);
	...
	public static Dialog createDeleteMemberDialog(Context context,
			View.OnClickListener listener, boolean isSingle) {
		Dialog dialog = new Dialog(context, R.style.default_dialog_style);
		final LayoutInflater inflater = LayoutInflater.from(context);
		...
		if (isSingle) {
			title.setText(context
					.getString(R.string.delete_member_confirm_hint));
		} else {
