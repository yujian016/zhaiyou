 ...
 * 
 */
public class PrivateSupermarketCartSubmitOrderActivity extends BaseActivity {

	String TAG = "PrivateSupermarketCartSubmitOrderActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		supermaket_id = data.getIntExtra("supermaket_id", 0);
		allchoicesock = (List<PrivateSuperMarketGoodsBean>) data
	...
	public void onClick(View v) {
		...
		case R.id.ib_digital_goback:
			PrivateSupermarketCartSubmitOrderActivity.this.finish();
			break;
		case R.id.pop_proxystocktip_pay:
			...
			if (balance >= order_sum_money) {
				...
				boolean alipayinstall = AlipayUtil
						.checkAlipayInstall(PrivateSupermarketCartSubmitOrderActivity.this);
				if (alipayinstall) {
					checkalipay();
				} else {
		...
		public View getView(final int position, View view, ViewGroup arg2) {
			...
			if (view == null) {
				...
				view = LayoutInflater.from(
						PrivateSupermarketCartSubmitOrderActivity.this)
				...
				if (TextUtils.isEmpty(returnstr)) {
					...
					try {
						...
						String schoolname = UserUtil
								.getschoolname(PrivateSupermarketCartSubmitOrderActivity.this);
						String hostelname = UserUtil
								.gethostelname(PrivateSupermarketCartSubmitOrderActivity.this);
						String floorname = UserUtil
								.getfloorname(PrivateSupermarketCartSubmitOrderActivity.this);
...
//				"0.01");
	...
	private void submitorder(int pay_type) {
		...
		for (int i = 0; i < allchoicesock.size(); i++) {
			PrivateSuperMarketGoodsBean sock = allchoicesock.get(i);
					...
					try {
						...
						if (resultMsg.contains("失败")) {
							...
							JpushGetIMEI_BY_UID__Push(
									UserUtil.getenterpsmid(PrivateSupermarketCartSubmitOrderActivity.this),
