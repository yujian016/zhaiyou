...
public class GamePlayDetailActivity extends BaseActivity {
	...
	String TAG = "GamePlayDetailActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dpid = getIntent().getIntExtra("gameid", 0);
	...
	public void initdata() {
		...
		params.addBodyParameter("game_id", dpid + "");

		loadData(HttpMethod.POST, GlobalConstant.GET_ONE_GAME_PLAY, params,
					...
					public void onSuccess(ResponseInfo<String> response) {
						...
						if (TextUtils.isEmpty(returnstr)) {
							...
							try {
								...
								tv_goods_detail_title.setText("游戏代练");
								tv_boss.setText("联系人信息");
								...
								String log1 = json.getString("log1");
								String log2 = json.getString("log2");
								String log3 = json.getString("log3");
								...
								if (!TextUtils.isEmpty(log2)) {
									...
									if (!log2.startsWith("http")) {
										log2 = GlobalConstant.SERVER_URL + log2;
									}
								...
								if (!TextUtils.isEmpty(log3)) {

									if (!log3.startsWith("http")) {
										log3 = GlobalConstant.SERVER_URL + log3;
									}
