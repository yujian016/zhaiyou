...
public class ApplyOpenShopActivity2 extends BaseActivity {

	String TAG = "ApplyOpenShopActivity2";
	...
	public void onClick(View v) {
		...
		case R.id.ib_apply_shop_close:
			ApplyOpenShopActivity2.this.finish();
			break;
		...
		case R.id.iv_apply_select_shop_log:
			menuWindow = new SelectPicPopuWindow(ApplyOpenShopActivity2.this,
					itemsOnClick);
			menuWindow.showAtLocation(
					ApplyOpenShopActivity2.this.findViewById(R.id.ll_apply),
		...
		http.send(HttpMethod.POST, GlobalConstant.SHOP_ACTION_OPEN_SHOP,
				params, new RequestCallBack<String>() {
					...
					public void onFailure(HttpException e, String msg) {
						...
						Toast.makeText(ApplyOpenShopActivity2.this, msg,
