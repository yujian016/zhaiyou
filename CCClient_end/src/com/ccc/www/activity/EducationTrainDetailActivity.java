...
public class EducationTrainDetailActivity extends BaseActivity {
	...
	String TAG = "EducationTrainDetailActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dpid = getIntent().getIntExtra("etid", 0);

		setContentView(R.layout.activity_educationtrain_detail);
		initview();
	}
	...
	public void initdata() {
		...
		params.addBodyParameter("et_id", dpid + "");

		loadData(HttpMethod.POST, GlobalConstant.GET_ONE_ET, params,
									...
									event_pic1
											.setOnClickListener(new OnClickListener() {
												...
												public void onClick(View arg0) {
													ImageUtil
															.toShowImages(
																	EducationTrainDetailActivity.this,
																	urls, 0);
												}
											});
