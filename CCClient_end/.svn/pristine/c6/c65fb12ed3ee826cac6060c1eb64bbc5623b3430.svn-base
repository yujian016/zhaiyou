...
public class ConversationListView {
	...
	public void initModule() {
		mTitle = (TextView) mConvListFragment
				.findViewById(R.id.main_title_bar_title);
		...
		mCreateGroup = (ImageButton) mConvListFragment
				.findViewById(R.id.create_group_btn);
		LayoutInflater inflater = (LayoutInflater) mContext
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mHeader = (LinearLayout) inflater.inflate(R.layout.conv_list_head_view,
				mConvListView, false);
